...
void setup() {   
  Serial.begin(9600); // Baudios a 9600.
  irsend.begin();
  delay(10);
}
//*******************************************************************
...
{  
  if (Serial.available() > 0)
  {
    ...
    {            
      Serial.println("ON/OFF"); // Envía mensaje por puerto serie.
      irsend.sendSAMSUNG(0xE0E040BF, 32);
    }          
    if (comando.equals("volS") == true) // Si el comando "volS" es verdadero. //Volumen+
    {            
      Serial.println("Volumen+"); // Envía mensaje por puerto serie.
    ...
    {            
      Serial.println("Prog+"); // Envía mensaje por puerto serie.
